...
#ifdef two_MASTER
// Usart steer defines to MASTER/SLAVE comunication pins
...
//#define USART_MASTERSLAVE USART0	// robo no second uart port yet.
...
// Usart steer defines
#define USART_STEER_COM USART1				
#ifdef USART_STEER_COM
	#define USART_STEER_RCU RCU_USART1			
	#define USART_STEER_AF	GPIO_AF_1				
	#define USART_STEER_COM_TX_PIN	GPIO_PIN_14  //6//11
	#define USART_STEER_COM_TX_PORT	GPIOA 			//B
	#define USART_STEER_COM_RX_PIN	GPIO_PIN_15  //7//10
	#define USART_STEER_COM_RX_PORT	GPIOA
#endif
#endif
// ADC defines

#define VBATT_PIN	GPIO_PIN_5				// robo, no gpio_mode_set() inHerleybob:setup.c 17 A
#define VBATT_PORT GPIOA							// robo, no gpio_mode_set() inHerleybob:setup.c
#define VBATT_CHANNEL ADC_CHANNEL_5	// 17 robo, based on Herleybob:setup.c: adc_regular_channel_config(2,ADC_CHANNEL_17,ADC_SAMPLETIME_13POINT5);

#define CURRENT_DC_PIN	GPIO_PIN_6	// robo, no gpio_mode_set() inHerleybob:setup.c
#define CURRENT_DC_PORT GPIOA					// robo, no gpio_mode_set() inHerleybob:setup.c
#define CURRENT_DC_CHANNEL ADC_CHANNEL_6	// robo, maybe adc_buf_t:adc is potentiometer input
