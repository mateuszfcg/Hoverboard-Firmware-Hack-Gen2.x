...
#define two_MASTER // MASTER/SLAVE comunication pins
...
#define TIMEOUT_MS          2000      // Time in milliseconds without steering commands before pwm emergency off
	...
	#define CELL_LOW_LVL2     3.0       // Battery almost empty, show orange battery symbol above this Level. Charge now! 
	#define CELL_LOW_DEAD     2.7       // Undervoltage lockout, show red battery symbol above this Level.
